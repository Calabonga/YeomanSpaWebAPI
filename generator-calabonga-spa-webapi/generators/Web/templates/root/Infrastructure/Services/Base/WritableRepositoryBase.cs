...
namespace YeomanTemplate.Web.Infrastructure.Services.Base {
    ...
    public abstract class WritableRepositoryBase<TModel, TUpdateModel, TCreateModel, TQueryParams> : ReadableRepositoryBase<TModel, TQueryParams>, IWritableRepository<TModel, TUpdateModel, TCreateModel, TQueryParams>
        ...
        public WritableRepositoryBase(IAppContext context, IAppConfig config, IMapper mapper, IServiceSettings settings, ILogService logger)
        ...
        public OperationResult<TUpdateModel> GetEditById(Guid id) {
